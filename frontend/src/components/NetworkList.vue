                ...
                <thead>
                    <tr>
                        <th class="check-col"><input class="bulk-checkbox" type="checkbox" :checked="allPageSelected"
                                @change="toggleSelectAllPage" /></th>
                        <th class="name-cell"><button class="sort-header" type="button" @click="toggleSort('name')">{{
                                t('networksView.name') }}<span class="sort-indicator">{{ getSortIndicator('name')
                                    }}</span></button></th>
                        <th><button class="sort-header" type="button" @click="toggleSort('id')">ID<span
                                    class="sort-indicator">{{ getSortIndicator('id') }}</span></button></th>
                        <th><button class="sort-header" type="button" @click="toggleSort('driver')">{{
                                t('networksView.driver') }}<span class="sort-indicator">{{ getSortIndicator('driver')
                                    }}</span></button></th>
                        <th class="scope-cell"><button class="sort-header" type="button" @click="toggleSort('scope')">{{
                                t('networksView.scope') }}<span class="sort-indicator">{{ getSortIndicator('scope')
                                    }}</span></button></th>
                        <th class="internal-cell"><button class="sort-header" type="button"
                                @click="toggleSort('internal')">{{ t('networksView.internal') }}<span
                                    class="sort-indicator">{{ getSortIndicator('internal') }}</span></button></th>
                ...
                <tbody>
                    <tr v-for="net in paginatedNetworks" :key="net.Id">
                        <td class="check-col"><input class="bulk-checkbox" type="checkbox"
                                :checked="selectedIds.includes(net.Id)" @change="toggleSelect(net.Id)" /></td>
