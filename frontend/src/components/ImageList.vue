            ...
            <table class="docker-table">
                <thead>
                    <tr>
                        ...
                        <th class="name-cell"><button class="sort-header" type="button"
                                @click="toggleSort('repoTag')">{{ t('imagesView.repositoryTag') }}<span
                                    class="sort-indicator">{{ getSortIndicator('repoTag') }}</span></button></th>
                        ...
                        <th class="size-cell"><button class="sort-header" type="button" @click="toggleSort('size')">{{
                            t('imagesView.size') }}<span class="sort-indicator">{{ getSortIndicator('size')
                                }}</span></button></th>
                        <th class="time-cell"><button class="sort-header" type="button"
                                @click="toggleSort('created')">{{ t('imagesView.created') }}<span
                ...
                <tbody>
                    <tr v-for="image in paginatedImages" :key="image.Id">
                        <td class="check-col"><input class="bulk-checkbox" type="checkbox"
                                :checked="selectedIds.includes(image.Id)" @change="toggleSelect(image.Id)" /></td>
